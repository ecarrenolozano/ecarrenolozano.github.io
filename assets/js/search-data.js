...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Academic publications organized in reverse order.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Repositories",
          description: "A list of official repositories to share with the community.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "projects-biocypher",
          title: 'BioCypher',
          description: "A unifying framework for biomedical knowledge graphs.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_project_biocypher/";
